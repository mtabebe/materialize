...
/// retain-only reference that pins those blobs against GC.
#[derive(Clone, Debug, PartialEq, Eq, PartialOrd, Ord, Serialize, Deserialize)]
#[cfg_attr(any(test, feature = "proptest"), derive(Arbitrary))]
...
/// One item of the catalog snapshot taken at the branch point, which
/// `SHOW BRANCH CHANGES` diffs the branch's current catalog against.
#[derive(Clone, Debug, PartialEq, Eq, PartialOrd, Ord, Serialize, Deserialize)]
#[cfg_attr(any(test, feature = "proptest"), derive(Arbitrary))]
